...
For a roll to be considered a [lexicWord]#flawless success# two conditions must be met:
...
The [lexicWord]#difficulty level# of the [lexicWord]#ego test# is equal to the [lexicWord]#rank# of the [lexicWord]#skill# which caused the [lexicWord]#completeFailure#.
