...
At the complete end of the book, you'll find an appendices section.
...
It is much easier to remember and calculate with a system where everything is based on base 10.
...
The metric system also avoid confusion when a decimal notation is used.
Knowning that 5.3 pounds is actually 5 pounds and 4 ounces and 6 drachms and 1 scruple and some minims is not necessarily intuitive.
And this is not even mentioning the possible confusion between ounces and troy ounces!

If you categorically refuse to use the metric system, a conversion chart is available at the end of the book with corresponding measure not exact but close enough to not break the systems and simple enough to calculate mentally (for example, 1 metre become 3 feet instead of 3 feet and 3 inches, a.k.a 3¼ or 3.25 feet).
