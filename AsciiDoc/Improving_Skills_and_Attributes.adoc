...
If a [lexicWord]#skill# is part of a [lexicWord]#skill group#, the [lexicWord]#rank# of the [lexicWord]#group# should be added to the [lexicWord]#skill# when calculating the [lexicWord]#experience# cost.

.Example
[caption=""]
====
A [lexicWord]#skill# with a [lexicWord]#rank# of 3, under a [lexicWord]#group# with a [lexicWord]#rank# of 2 would cost 24 [lexicWord]#experience points# ((3+2+1)*4) to raise to a [lexicWord]#rank# of 4.
====

== Improving Skill Groups

When 3 [lexicWord]#skills# in a [lexicWord]#group# have at least one [lexicWord]#rank#, they must be each reduced by one [lexicWord]#rank# to increase the [lexicWord]#rank# of the [lexicWord]#group# by one.
