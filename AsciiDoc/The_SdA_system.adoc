...
Whenever a [lexicWord]#player# desires to attempt an action with a probability of failure, the [lexicWord]#GM# may ask for a [lexicWord]#skill test#.
...
The resulting combination of the number and the type of dice is called the [lexicWord]#dice-pool#.
...
Even if a [lexicWord]#character# has no rank in a [lexicWord]#skill#, the [lexicWord]#player# can always roll at least 1 die.
