...
** This test is made by rolling a [lexicWord]#dice-pool# composed of a number of dice equals to the [lexicWord]#rank# of the [lexicWord]#skill# associated with the task plus one.

*** If a [lexicWord]#skill# is part of a [lexicWord]#group#, the [lexicWord]#ranks# of the [lexicWord]#group# are added to the [lexicWord]#ranks# of the [lexicWord]#skill#.
...
** [lexicWord]#Skills# are increased by spending a number of its [lexicWord]#experience points# equal to its [lexicWord]#rank# plus 1 (plus the [lexicWord]#rank# of its [lexicWord]#group# if applicable), multiplied by 4.

** [lexicWord]#Skills group# don't earn their own experience and are increased by subtracting one rank from 3 of its [lexicWord]#skills#.
...
** They can make a [lexicWord]#virtue roll# to gain a [lexicWord]#bonus# to every actions in accordance to the side of the [lexicWord]#virtue# called upon.
