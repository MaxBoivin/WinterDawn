...
Since playing Warcraft(TM) has a youth, I always had a soft spot for Orcs and Goblins.

On the other hand, Elves usually bore me (although, I'm happy with the spin I gave them in this game).

I tried to keep all the difference races as balanced as I could.
Perfect evenness can never be achieved since the potency of a different features is dependent upon the setting and type of game you're engaged in.
