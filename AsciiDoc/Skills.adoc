...
[lexicWord]#Skills# (and [lexicWord]#attributes#) can also give information about how the [lexicWord]#character# should be (role) played; a character with a high [lexicWord]#Confidence & ego# will act differently than one with no [lexicWord]#ranks# in this [lexicWord]#skill#.
...
The [lexicWord]#skills# are presented in alphabetical order.

:leveloffset: +1

'''

include::Skills/Acrobatics.adoc[]
