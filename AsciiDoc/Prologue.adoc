...
Please take note that the different races (which are more like species) presented in this book are from the realm of fantasy.
They do not represent any real-world racial or cultural groups.
