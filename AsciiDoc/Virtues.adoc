...
| Faith | Iconoclast / Skeptic | Devoted / Zealot
// | Friendliness | Aloof / Reserved | Fawning / Caring
| Integrity | Devious / Cunning | Frank / Pedantic
...
| Iconoclast | Skeptic 2+| Faithful | Devoted | Zealot
| Devious | Cunning 2+| Honest | Frank | Pedantic
| Meek | Humble 2+| Proud | Dignified | Vain
| Debauched | Epicurean 2+| Tempered | Disciplined | Insensitive
|===
////
